                ...
                with col2:
                    for date in df['month&year'].unique():
                        ...
                        if flag:
                            ...
                            with st.expander('Проблемы с товаром'):
                                drilldown = temp.query('type_of_problem == "defect"')

                                drilldown['marketplace'] = drilldown['marketplace'].apply(lambda x: lexicon.lexicon_dict[x])
